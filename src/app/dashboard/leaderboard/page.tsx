...
export default function StudentLeaderboardPage() {
  ...
  const rankColors = ['from-yellow-400 to-amber-500', 'from-slate-350 to-slate-450', 'from-orange-600 to-amber-700']
        ...
        <div className="grid grid-cols-3 gap-4 max-w-2xl mx-auto my-8 items-end">
          ...
          {topThree[1] && (
            <div className="text-center p-5 rounded-2xl bg-slate-800/20 border border-slate-700/30 space-y-2">
              ...
              <div className="w-10 h-10 mx-auto rounded-lg bg-orange-500/10 flex items-center justify-center text-orange-400 font-bold text-xs">
          ...
          {/* 1st Place */}
          {topThree[0] && (
            <div className="text-center p-6 rounded-2xl bg-slate-800/35 border border-slate-700/50 space-y-2.5 ring-1 ring-orange-500/20 scale-105">
              ...
              <div className="w-12 h-12 mx-auto rounded-lg bg-orange-500/15 flex items-center justify-center text-orange-400 font-bold text-sm">
              ...
              <p className="text-base font-black text-orange-400 font-mono">{topThree[0].totalPoints} XP</p>
            </div>
          )}
          ...
          {topThree[2] && (
            <div className="text-center p-5 rounded-2xl bg-slate-800/20 border border-slate-700/30 space-y-2">
              <div className="w-10 h-10 mx-auto rounded-xl bg-gradient-to-br from-orange-600 to-amber-700 flex items-center justify-center text-white shadow-lg">
              ...
              {filteredLeaderboard.map((entry) => (
                <tr key={entry.id} className="border-b border-slate-800/50 hover:bg-slate-900/10 transition-colors">
                  <td className="px-5 py-3.5 font-bold font-mono text-slate-400">
                    {entry.rank <= 3 ? (
                      <span className="inline-flex w-6 h-6 rounded bg-orange-500/10 text-orange-400 items-center justify-center text-[10px]">
                        {entry.rank}
                      </span>
                    ) : (
                  ...
                  <td className="px-5 py-3.5">
                    <div className="flex items-center gap-2.5">
                      <div className="w-8 h-8 rounded-lg bg-orange-500/10 flex items-center justify-center text-orange-400 font-bold text-[10px]">
                  ...
                  <td className="px-5 py-3.5 text-right font-bold text-orange-400 font-mono">{entry.totalPoints} XP</td>
                </tr>
              ))}
            </tbody>
          </table>
